...
//         <div className="block md:hidden">
//           <div className="flex items-center gap-4 mb-2 mt-2">
//             <img src={Logo} alt="HaschCode Logo" className="w-12 h-12 bg-white p-1 rounded" />
//             <h2 className="text-2xl font-bold font-cairo">HaschCode</h2>
//           </div>
//           <div className="mb-2">
//             <h3 className="text-lg font-semibold mb-1 font-cairo">{t('footer.aboutUs')}</h3>
...
//             <div className="col-span-1 md:col-span-5">
//               <div className="flex items-center gap-4 mb-4 mt-8">
//                 <img src={Logo} alt="HaschCode Logo" className="w-16 h-16 bg-white p-1 rounded" />
//                 <h2 className="text-5xl font-bold font-cairo">HaschCode</h2>
//               </div>
//             </div>
//             <div className="col-span-1 md:col-span-2">
        ...
        <div className="block md:hidden">
          <div className="flex items-center gap-4 mb-2 mt-2">
            <div className="relative w-12 h-12">
              <div className="absolute inset-0 bg-white rounded p-1 z-0"></div>
              <img 
                src={Logo} 
                alt="HaschCode Logo" 
