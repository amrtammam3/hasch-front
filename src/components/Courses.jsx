...
const Courses = () => {
  ...
  // Define circle sizes and border widths for Mobile Layout
  const mobileTopLeftCircleSize = '80px'; // Width and height for top-left circle (mobile)
  const mobileTopLeftBorderWidth = '2px'; // Border thickness for top-left circle (mobile)

  const mobileMiddleRightCircleSize = '64px'; // Width and height for middle-right circle (mobile)
  const mobileMiddleRightBorderWidth = '2px'; // Border thickness for middle-right circle (mobile)

  const mobileBottomMiddleCircleSize = '80px'; // Width and height for bottom-middle circle (mobile)
  const mobileBottomMiddleBorderWidth = '2px'; // Border thickness for bottom-middle circle (mobile)

  // Define circle sizes and border widths for Desktop Layout
  const desktopTopLeftCircleSize = '130px'; // Width and height for top-left circle (desktop)
  const desktopTopLeftBorderWidth = '2px'; // Border thickness for top-left circle (desktop)

  const desktopMiddleRightCircleSize = '128px'; // Width and height for middle-right circle (desktop)
  const desktopMiddleRightBorderWidth = '2px'; // Border thickness for middle-right circle (desktop)

  const desktopBottomMiddleCircleSize = '160px'; // Width and height for bottom-middle circle (desktop)
  const desktopBottomMiddleBorderWidth = '2px'; // Border thickness for bottom-middle circle (desktop)
  ...
  return (
    <>
      ...
      <div className="block md:hidden relative bg-white dark:bg-[#1A0B2E] py-10 min-h-screen overflow-hidden">
        {/* Decorative circles */}
        {/* Top-left circle (mobile) */}
        {/* Adjust size with mobileTopLeftCircleSize, thickness with mobileTopLeftBorderWidth */}
        <span className="absolute top-0 left-0 rounded-full border-[#8169F1] opacity-30" style={{
          width: mobileTopLeftCircleSize,
          height: mobileTopLeftCircleSize,
          borderWidth: mobileTopLeftBorderWidth
        }}></span>

        {/* Middle-right circle (mobile) */}
        {/* Adjust size with mobileMiddleRightCircleSize, thickness with mobileMiddleRightBorderWidth */}
        <span className="absolute top-1/2 right-0 rounded-full border-[#8169F1] opacity-30" style={{
          width: mobileMiddleRightCircleSize,
          height: mobileMiddleRightCircleSize,
          borderWidth: mobileMiddleRightBorderWidth
        }}></span>

        {/* Bottom-middle circle (mobile) */}
        {/* Adjust size with mobileBottomMiddleCircleSize, thickness with mobileBottomMiddleBorderWidth */}
        <span className="absolute bottom-0 left-1/2 rounded-full border-[#8169F1] opacity-30" style={{
          width: mobileBottomMiddleCircleSize,
          height: mobileBottomMiddleCircleSize,
          borderWidth: mobileBottomMiddleBorderWidth
        }}></span>
      ...
      <div className="hidden md:block relative">
        <div className="bg-white dark:bg-[#1A0B2E] py-20 transition-colors duration-300 overflow-hidden">
          {/* Decorative circles */}
          {/* Top-left circle (desktop) */}
          {/* Adjust size with desktopTopLeftCircleSize, thickness with desktopTopLeftBorderWidth */}
          <span className="absolute top-0 left-80 rounded-full border-[#8169F1] opacity-30" style={{
            width: desktopTopLeftCircleSize,
            height: desktopTopLeftCircleSize,
            borderWidth: desktopTopLeftBorderWidth
          }}></span>

          {/* Middle-right circle (desktop) */}
          {/* Adjust size with desktopMiddleRightCircleSize, thickness with desktopMiddleRightBorderWidth */}
          <span className="absolute top-1/2 right-0 rounded-full border-[#8169F1] opacity-30" style={{
            width: desktopMiddleRightCircleSize,
            height: desktopMiddleRightCircleSize,
            borderWidth: desktopMiddleRightBorderWidth
          }}></span>

          {/* Bottom-middle circle (desktop) */}
          {/* Adjust size with desktopBottomMiddleCircleSize, thickness with desktopBottomMiddleBorderWidth */}
          <span className="absolute bottom-0 left-1/2 rounded-full border-[#8169F1] opacity-30" style={{
            width: desktopBottomMiddleCircleSize,
            height: desktopBottomMiddleCircleSize,
            borderWidth: desktopBottomMiddleBorderWidth
          }}></span>
