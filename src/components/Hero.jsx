...
//             isDesktop
//               ? `${isArabic ? 'w-1/3 left-[-75px] top-[77%]' : 'w-1/3 -right-20 top-[77%]'} intermediate:w-[17vw] intermediate:h-[35vh] intermediate:top-[80%] ${isArabic ? 'intermediate:left-[0%]' : 'intermediate:right-[0%]'}` 
//               : `${isArabic ? 'w-2/5 right-40 top-[65%]' : 'w-2/5 -right-3 top-[65%]'}`
//           )}
//           loading="lazy"
//         />
//       </div>
...
// Subcomponent to display text content (title and description)
const HeroText = ({ isDesktop, isIntermediate }) => {
  const { t, i18n } = useTranslation();
  const isArabic = i18n.resolvedLanguage === 'ar' || localStorage.getItem('i18nextLng') === 'ar';
  ...
  const titleClass = clsx(
    baseTextClass,
    isDesktop ? 'text-[32px]' : isIntermediate ? 'text-[28px]' : 'text-[24px] mb-6 ml-4'
  );

  const paragraphClass = clsx(
    baseTextClass,
    'font-medium',
    isDesktop ? 'text-[20px]' : isIntermediate ? 'text-[18px]' : 'text-[16px]'
  );

  return (
    <div
      className={clsx(
        isDesktop ? 'space-y-6 max-w-xl ml-20 mt-[-100px]' : isIntermediate ? 'space-y-4 max-w-[40vw] ml-12' : 'space-y-2 max-w-md ml-4')
      }
    >
      <h1 className={titleClass} aria-label={t('hero.title')}>
        {isArabic ? (
...
// Subcomponent to display images (laptop and phone mockups)
const HeroImages = ({ isDesktop, isIntermediate, isArabic }) => {
  return (
    <div className="relative">
      <div
        className={clsx(
          'relative z-10',
          isDesktop ? 'transform -translate-x-36 pt-52' : isIntermediate ? 'transform -translate-x-20 pt-32' : ''
        )}
      >
        <img
          src={laptopMockup}
          ...
          className={clsx(
            ...
            isDesktop ? 'max-w-3xl scale-110' : isIntermediate ? 'max-w-[50vw]' : 'max-w-lg scale-110'
          )}
          loading="lazy"
        />
        <img
          ...
          className={clsx(
            ...
            isDesktop
              ? `${isArabic ? 'w-1/3 left-[-20px] top-[77%] scale-120' : 'w-1/3 -right-20 top-[77%] scale-120'}`
              : isIntermediate
              ? `${isArabic ? 'w-[17vw] left-[-10px] top-[77%]' : 'w-[17vw] -right-10 top-[77%]'}`
              : `${isArabic ? 'w-2/5 left-[-10px] top-[65%] scale-120' : 'w-2/5 -right-3 top-[65%] scale-120'}`
          )}
          loading="lazy"
        />
      </div>
...
const HeroWave = () => (
  <div className="absolute bottom-0 left-0 right-0 overflow-hidden">
    <svg
      className="w-full"
      height={clsx('350', 'intermediate:h-[250px]', 'md:h-[200px]')}
      viewBox="0 0 1440 320"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      preserveAspectRatio="none"
  ...
  return (
    <>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-8 relative pt-0">
          <div className="flex flex-col">
            <HeroText isDesktop={false} isIntermediate={false} />
            <div className="flex flex-row items-center justify-between w-full">
              <div className="mb-14 space-y-2 max-w-md ml-9">
                <p
                  className={clsx(
              ...
              <HeroImages isDesktop={false} isIntermediate={false} isArabic={isArabic} />
            </div>
          </div>
        </div>
        <HeroWave />
      ...
      >
        <HeroBackground />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative pt-10 intermediate:px-6 intermediate:pt-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center intermediate:flex intermediate:flex-row intermediate:items-center intermediate:gap-8">
            <HeroText isDesktop={true} isIntermediate={window.innerWidth >= 768 && window.innerWidth < 1024} />
            <HeroImages isDesktop={true} isIntermediate={window.innerWidth >= 768 && window.innerWidth < 1024} isArabic={isArabic} />
          </div>
        </div>
        <HeroWave />
      </div>
...
//       src={ellipse16}
//       alt="Ellipse"
//       className="absolute w-[4.5vw] h-[4.2vw] top-32 left-[40%] transform -translate-x-1/2 brightness-110"
//       loading="lazy"
//     />
//     <img
//       src={ellipse16}
//       alt="Ellipse"
//       className="absolute w-[4.5vw] h-[4.2vw] top-40 left-16 brightness-150"
//       loading="lazy"
//     />
//     <img
//       src={ellipse16}
//       alt="Ellipse"
//       className="absolute w-[4.5vw] h-[4.2vw] right-1/4 transform -translate-x-1/3 top-60 right-[2px] brightness-125"
//       loading="lazy"
//     />
//     <img
//       src={ellipse10}
//       alt="Ellipse"
//       className="absolute w-[6.5vw] h-[6.5vw] bottom-80 right-1/4 transform -translate-x-40 -translate-y-2 brightness-125"
//       loading="lazy"
//     />
//     <img
//       src={ellipse16}
//       alt="Ellipse"
//       className="absolute w-[4.5vw] h-[4.2vw] bottom-60 left-1/4 transform -translate-x-1/2 brightness-125"
//       loading="lazy"
//     />
//   </div>
// );
...
//   const titleClass = clsx(
//     baseTextClass,
//     isDesktop ? 'text-[2rem]' : 'text-[1.5rem] mb-6 ml-4'
//   );
...
//     <div
//       className={clsx(
//         isDesktop ? 'space-y-6 max-w-[40vw] ml-20 mt-[-100px]' : 'space-y-2 max-w-md ml-4'
//       )}
//     >
//       <h1 className={titleClass} aria-label={t('hero.title')}>
//         {isArabic ? (
...
//         className={clsx(
//           'relative z-10',
//           isDesktop ? 'transform -translate-x-36 pt-52' : ''
//         )}
//       >
//         <img
//           src={laptopMockup}
...
//           className={clsx(
//             'w-full object-contain',
//             isDesktop ? 'max-w-3xl scale-110' : 'max-w-lg scale-110'
//           )}
//           loading="lazy"
//         />
//         <img
...
//       {/* Desktop section (768px and above) */}
//       <div
//         className="hidden md:block relative bg-gradient-to-r from-[#8169F1] to-[#4A3D8B] dark:from-[#4A3D8B] dark:to-[#13022E] min-h-screen flex items-center overflow-hidden transition-colors duration-300"
//         style={{ direction: isArabic ? 'rtl' : 'ltr' }}
//         role="banner"
