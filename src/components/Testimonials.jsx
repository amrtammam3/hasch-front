    ...
    <>
      ...
      <div className="hidden md:block">
        <div className="py-20 bg-gradient-to-r from-[#4A3D8B] via-[#51449C] to-[#4A3D8B] transition-colors duration-300 dark:bg-gradient-to-r dark:from-[#4A3D8B] dark:to-[#13022E]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-[#FFFFFF] dark:text-[#1DBFFE] mb-6">
                {t('testimonials.title')} {t('testimonials.subtitle')}
              </h2>
              <p className="hidden"></p>
            </div>
            <div className="relative flex flex-col md:flex-row items-center justify-between gap-12">
              <div
                className="p-8 w-full md:w-1/2 relative z-10 mx-auto mb-8 md:mb-0 before:content-[''] before:absolute before:top-0 before:left-[-2px] before:w-[2px] before:h-[140px] before:border-l-2 before:border-dashed before:border-l-transparent before:border-image-[linear-gradient(to_bottom,#4A3D8B,#1DBFFE)_1] after:content-[''] after:absolute after:top-0 after:right-[-2px] after:w-[2px] after:h-[140px] after:border-r-2 after:border-dashed after:border-r-transparent after:border-image-[linear-gradient(to_bottom,#4A3D8B,#1DBFFE)_1]"
                style={{
                  border: '2px dashed #1DBFFE',
            ...
            <div className={isArabic ? 'flex justify-center mt-10 space-x-2 space-x-reverse' : 'flex justify-center mt-10 space-x-2'}>
              {testimonials.map((_, index) => (
                <button
                  key={index}
                  onClick={() => setCurrentTestimonial(index)}
